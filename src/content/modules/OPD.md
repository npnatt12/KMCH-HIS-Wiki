...
- **Status** — จัดตาม [OPD Patient Status](/concepts/opd-patient-status/)
...
## [Patient Status Flow](/concepts/opd-patient-status/) (8 สถานะ)
...
- **Charting** → Vital Sign Chart → Save → แสดงใน EMR Observation + [Patient Banner](/entities/patient-banner/)
...
- ชื่อผู้ป่วยส่งไป[แผนกการเงิน](/modules/billing/)ทันที
...
| Module | Integration |
|--------|-------------|
| [Registration](/modules/registration/) | ผู้ป่วยมาจากการลงทะเบียน, Appointments tab |
| [ER](/modules/er/) | ผู้ป่วย ER ส่งต่อ |
| [Billing](/modules/billing/) | Medical Discharge → OP Cashier Worklist |
| [LAB](/modules/lab/) | Specimen Collection, Lab results |
| [XRAY](/modules/xray/) | Radiology results |
| [EMR Doctor](/modules/emr-doctor/) | แพทย์ใช้ EMR สั่ง orders |
| [Admission](/modules/admission/) | Request Admission จาก OPD |
