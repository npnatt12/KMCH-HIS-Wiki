...
2. ระบบแสดง [[Patient Search Screen]] — กรอกข้อมูลค้นหา แล้วกด Search
3. หากไม่พบผู้ป่วย ระบบแสดง Error Box → กด OK
4. กดปุ่ม **New** เพื่อสร้างผู้ป่วยใหม่
5. กรอกข้อมูลใน [[Patient Demographics Screen]] ครบทุก Mandatory Fields
...
### 3. [[Appointment Registration|ผู้ป่วยนัด (Appointment Patient Registration)]]
...
**วิธีที่ 2:** [[OPD]] → OPD Worklist → Tab APPOINTMENTS → เลือกรายชื่อผู้ป่วย → กดลงทะเบียน → SAVE

### 4. [[Emergency Registration|ผู้ป่วยฉุกเฉิน (Emergency Patient Registration)]]
...
### 5. [[Mass Casualty Registration|อุบัติภัยหมู่ (Mass Casualty)]]
...
### 6. [[Registration Update Merge Workflow|Modify Demographics — แก้ไขข้อมูลประวัติผู้ป่วย]]
...
### 7. [[NHSO Authentication|ตรวจสอบสิทธิ สปสช. (NSHO Authentication)]]
...
|-------|------|-------------|
| VIP | Toggle + Dropdown | เปิด VIP → เลือก VIP Type — แสดงสัญลักษณ์บน [[Patient Banner]] |
...
| [[MRD]] | สร้าง OPD Folder อัตโนมัติเมื่อ New Register |
