...
| [OR Schedule](/entities/or-schedule-screen/) | ตาราง Calendar นัดห้องผ่าตัด — Click ช่องว่างเพื่อจอง |
| **OR Worklist** | รายชื่อผู้ป่วยที่จะมาผ่าตัดวันนี้ พร้อมเมนูย่อย 10 รายการ |
| [OR Record](/entities/or-record-screen/) | บันทึกรายละเอียดการผ่าตัดจริง (Intra-op) |
...
ดูรายละเอียดทุก Field ที่ [OR Schedule Screen](/entities/or-schedule-screen/)
...
ดูรายละเอียดทุก Field ที่ [OR Record Screen](/entities/or-record-screen/)
...
| [ER](/modules/er/) | Emergency → Send to OR |
| [IPD](/modules/ipd/) | ผู้ป่วยในส่งผ่าตัด |
| [Admission](/modules/admission/) | ผู้ป่วย OR อาจต้อง Admit หลังผ่าตัด |
| [Billing](/modules/billing/) | OR charges |

## Workflows

- [OR Surgery Request to Record Workflow](/workflows/or-surgery-request-to-record-workflow/) — กระบวนการครบตั้งแต่ Request ถึง Recovery Room
