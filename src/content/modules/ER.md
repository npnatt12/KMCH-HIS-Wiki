...
- **[ESI Level](/concepts/esi-level/)** — สีแสดงระดับความรุนแรง
...
- **[ESI Level](/concepts/esi-level/)** — ระบบแสดงอัตโนมัติเมื่อประเมิน
...
### 1. [Emergency Registration](/workflows/emergency-registration/)
Emergency → Emergency Registration → New/Existing → Basic Details + Emergency Detail + Visit Detail → Save

### 2. [Mass Casualty Registration](/workflows/mass-casualty-registration/)
...
|------------------|--------|
| **Discharge** | จำหน่ายปกติ → Medical Discharge → ส่ง[การเงิน](/modules/billing/) |
| **Death** | บันทึกรายละเอียดการเสียชีวิต |
| **Referred to Admission** | รับเป็นผู้ป่วยใน → ส่ง[Admission](/modules/admission/) |
| **Referred to Other Hospital** | ส่งต่อโรงพยาบาลอื่น |
| **Send to OR** | ส่งผ่าตัด → ส่ง[OR](/modules/or/) |
...
|-----------------|----------|----------------|---------|
| **Discharge** | จำหน่ายปกติ | — (บันทึก วัน+เวลา+แพทย์+ประเภท+สถานะ) | Status → Medical Discharge → [Billing](/modules/billing/) |
| **Death** | ผู้ป่วยเสียชีวิต | ระบุรายละเอียดการเสียชีวิตเพิ่มเติม | Status → Medical Discharge (บันทึกเสียชีวิต) |
| **Referred to Admission** | รับเป็นผู้ป่วยใน | ระบุรายละเอียดการรับผู้ป่วยใน | ส่ง [Admission](/modules/admission/) |
| **Referred to Other Hospital** | ส่งตัวโรงพยาบาลอื่น | ระบุรายละเอียดการส่งตัว + ปลายทาง | เตรียมเอกสารส่งตัว |
| **Send to OR** | ส่งผ่าตัด | ระบุรายละเอียดการผ่าตัด | ส่ง [OR](/modules/or/) |

**หลัง Save (ทุก status):** สถานะผู้ป่วยเปลี่ยนเป็น **Medical Discharge** → เข้าสู่กระบวนการทางการเงิน

## [ESI Level](/concepts/esi-level/) — สีแสดงบน Whiteboard
...
*ระบบแสดงสีที่ ESI Level column ใน [Whiteboard](/entities/whiteboard/) อัตโนมัติหลัง Triage*
...
- **Referred to Admission**: หลัง Save ระบบส่งข้อมูลไป [Admission](/modules/admission/) — ต้องมีข้อมูล ward/bed ที่แผนก Admission ดำเนินการต่อ
...
| Module | Integration |
|--------|-------------|
| [Registration](/modules/registration/) | Emergency Registration, Mass Casualty |
| [Admission](/modules/admission/) | Referred to Admission → IPD |
| [OR](/modules/or/) | Send to OR |
| [Billing](/modules/billing/) | Medical Discharge → billing process |
| [OPD](/modules/opd/) | ผู้ป่วย ER อาจส่งต่อ OPD |
