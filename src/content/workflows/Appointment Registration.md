...
2. [[Patient Search Screen]] → ค้นหาผู้ป่วย → กด **Search**
3. ระบบแสดงรายชื่อ + **รายละเอียด Appointments**
4. กด **SELECT** → ระบบแสดง [[Patient Demographics Screen]]
...
1. [[OPD]] → **OPD Worklist** → Tab **APPOINTMENTS**
...
- [[Registration]] — module page (workflow #3)
- [[OPD Worklist Screen]] — Appointments tab
- [[Visit Types]] — Visit Detail
