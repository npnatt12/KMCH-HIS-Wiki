...
สถานะของรายการตรวจทางห้องปฏิบัติการ ([LAB](/modules/lab/)) และรังสีวินิจฉัย ([XRAY](/modules/xray/))
...
- [LAB](/modules/lab/) → [Lab Specimen Collection Screen](/entities/lab-specimen-collection-screen/) / Lab Worklist / [Lab Result Entry Screen](/entities/lab-result-entry-screen/)
- [XRAY](/modules/xray/) → [XRAY Register Screen](/entities/xray-register-screen/) / [XRAY Report Screen](/entities/xray-report-screen/)
- [Lab Order to Result](/workflows/lab-order-to-result/) — Workflow LAB
- [XRAY Order to Report Workflow](/workflows/xray-order-to-report-workflow/) — Workflow XRAY
- [OPD](/modules/opd/) / [IPD](/modules/ipd/) → Specimen Collection, View results in EMR
- [Billing](/modules/billing/) → Lab/Radiology order status check ก่อนออกบิล
