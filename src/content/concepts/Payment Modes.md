...
MEDHIS รองรับการชำระเงิน **5 รูปแบบ** ในระบบ [Billing](/modules/billing/) ทั้ง OP และ IP
...
- [Billing](/modules/billing/) → OP Billing / IP Settlement → Settle step
- [Billing Settlement Screen](/entities/billing-settlement-screen/) — หน้าจอชำระเงินแสดงทุก Payment Mode
- [Billing](/modules/billing/) → Deposit — รับ/ตัดใช้/คืนเงินมัดจำ (ใช้ Payment Mode เดียวกัน)
